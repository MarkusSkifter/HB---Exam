...
\]
where $\pi_1 = 0.6$ and $y_t = t + b$. All other equations are unchanged. Because workers have perfect foresight, equation (7$´$) enters the Bellman equation from period 1 onward, and workers in years before 8 already account for the future subsidy when optimising.
